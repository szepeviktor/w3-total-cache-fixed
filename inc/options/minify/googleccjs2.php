...
<tr>
    <th>&nbsp;</th>
    <td>
        <input class="minifier_test js_enabled button {type: 'googleccjs', nonce: '<?php echo wp_create_nonce( 'w3tc' ); ?>'}" type="button" value="<?php _e( 'Test Closure Compiler', 'w3-total-cache' ); ?>" />
