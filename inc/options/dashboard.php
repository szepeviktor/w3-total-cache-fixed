...
<form id="w3tc_dashboard" action="admin.php?page=<?php echo $this->_page; ?>" method="post">
    <p>
        ...
        <input class="button" type="submit" name="w3tc_flush_apcu" value="<?php _e('empty only the APCu cache(s)', 'w3-total-cache') ?>"<?php if (! $can_empty_apcu): ?> disabled="disabled"<?php endif; ?> /> <?php _e('or', 'w3-total-cache') ?>
    ...
    <div id="w3tc-dashboard-widgets" class="clearfix widefat metabox-holder">
        ...
        <div id="postbox-container-left" style="float: left;">
            ...
            <div id="dashboard-text" style="display:inline-block;">
                ...
                <p>Thanks for choosing <a href="https://github.com/szepeviktor/w3-total-cache-fixed/" target="_blank">W3 Total Cache (Fixed)</a> &ndash; forked from <a href="https://wordpress.org/plugins/w3-total-cache/" target="_blank">W3 Total Cache</a> by <a href="https://profiles.wordpress.org/fredericktownes/" target="_blank">Frederick Townes</a> &ndash; as your Web Performance Optimization (<acronym title="Web Performance Optimization">WPO</acronym>) framework. Eventually, this dashboard will provide at-a-glance insight into key performance indicators for this WordPress installation. Please share <a href="https://github.com/szepeviktor/w3-total-cache-fixed/issues/new" target="_blank">your suggestions or issues</a>, if you have any. We'd love to hear them!</p>
            </div>
