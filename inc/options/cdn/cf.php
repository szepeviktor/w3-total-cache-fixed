	...
	<td>
		<input id="cdn_cf_bucket" type="text" name="cdn.cf.bucket"
                       <?php $this->sealing_disabled('cdn') ?> value="<?php echo esc_attr($this->_config->get_string('cdn.cf.bucket')); ?>" size="30" />
						<select id="cdn_cf_bucket_location" name="cdn.cf.bucket.location" style="margin-top:-4px">
		...
		<b>or</b>
		<input id="cdn_create_container" class="button {type: 'cf', nonce: '<?php echo wp_create_nonce('w3tc'); ?>'}" type="button" value="<?php _e('Create as new bucket with distribution', 'w3-total-cache'); ?>" />
