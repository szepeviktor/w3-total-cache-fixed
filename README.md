...
1. Download and unpack: **_[Master](https://github.com/szepeviktor/w3-total-cache-fixed/archive/master.zip)_** into `/wp-content/plugins/`
1. Rename the extracted directory from `w3-total-cache-fixed` to `w3-total-cache`
